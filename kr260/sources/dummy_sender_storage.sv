...
// | Or to enable word-wide writes on port A, specify the same value as for WRITE_DATA_WIDTH_B.                          |
...
// | Specify the total memory array size, in bits.                                                                       |
      .MEMORY_SIZE(8192),             // DECIMAL (* (expt 2 7) 64)8192
